...
// 	CryError( "Invalid parameter detected in function %s. File: %s Line: %d, Expression: %s",sFunc,sFile,line,sExpression );
//	CryError( "Invalid parameter detected in CRT function" );
}
...
{
#if !defined (USE_MULTICORE_SAVE_TIMING)
	return __rdtsc();
#else
	LARGE_INTEGER li;
