...
{
	ESPLINE_KEY_UI_SELECTED_START_DIMENSION			=  0x000008,  //000...0001000

	ESPLINE_KEY_UI_SELECTED_FIRST_DIMENSION			=  0x000008,  //000...0001000
	ESPLINE_KEY_UI_SELECTED_SECOND_DIMENSION		=  0x000010,  //000...0010000
	ESPLINE_KEY_UI_SELECTED_THIRD_DIMENSION			=  0x000020,  //000...0100000
	ESPLINE_KEY_UI_SELECTED_FOURTH_DIMENSION		=  0x000040,  //000...1000000
	ESPLINE_KEY_UI_SELECTED_ALL_DIMENSIONS			=  0x000078,  //000...1111000 

	ESPLINE_KEY_UI_SELECTED_NUMBER_OF_DIMENSIONS	=  0x000004,  // As splines can have now up to four dimensions,
															      // we have to iterate from Dimension 0 to 3.
																  // Suggested iteration is using the index of the
																  // for shifting a 0x8 constant and mask it.

	ESPLINE_KEY_UI_SELECTED  = 0x10000,
};

// Helper function, standardizing the test.
inline bool IsSplineKeySelectedAtDimension(int nFlags, int nDimension)
{
	return ((nFlags&ESPLINE_KEY_UI_SELECTED)&&(nFlags&ESPLINE_KEY_UI_SELECTED_START_DIMENSION<<nDimension));
}
