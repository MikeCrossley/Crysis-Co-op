...
----------------------------------------------------------------------------------------------------
function Coop:PlayRadioAlert(alertName, teamId)
...
----------------------------------------------------------------------------------------------------
function Coop:QueueVoice(soundName, soundFlags, soundSemantics, soundGap, endProc, endProcParam)
...
----------------------------------------------------------------------------------------------------
function Coop:UpdateVoiceQueue(frameTime)
...
----------------------------------------------------------------------------------------------------
function Coop:OnEnterVehicleSeat(vehicle, seat, entityId)
	if(self.isServer) then
...
----------------------------------------------------------------------------------------------------
function Coop:OnLeaveVehicleSeat(vehicle, seat, passengerId, exiting)
	if(self.isServer) then
		if(exiting) then
...
----------------------------------------------------------------------------------------------------
function Coop.Server:OnItemPickedUp(itemId, actorId)
	self.game:AbortEntityRemoval(itemId);
end


----------------------------------------------------------------------------------------------------
function Coop.Server:OnItemDropped(itemId, actorId)
...
----------------------------------------------------------------------------------------------------
function Coop:CanWork(entityId, playerId, work_type)
	if (self.isServer) then
...
----------------------------------------------------------------------------------------------------
function Coop:StartWork(entityId, playerId, work_type)
	local work=self.works[playerId];
	if (not work) then
		work={};
...
----------------------------------------------------------------------------------------------------
function Coop:StopWork(playerId)
	local work=self.works[playerId];
...
----------------------------------------------------------------------------------------------------
function Coop:Work(playerId, amount, frameTime)
	local work=self.works[playerId];
	if (work and work.active) then
...
----------------------------------------------------------------------------------------------------
function Coop.Client:ClStartWorking(entityId, workName)
...
----------------------------------------------------------------------------------------------------
function Coop.Client:ClStepWorking(amount)
	HUD.SetProgressBar(true, amount, self.work_name or "");
end


----------------------------------------------------------------------------------------------------
function Coop.Client:ClStopWorking(entityId, complete)
	HUD.SetProgressBar(false, -1, "");
end


----------------------------------------------------------------------------------------------------
function Coop.Client:ClWorkComplete(entityId, workName)
	local sound;		
