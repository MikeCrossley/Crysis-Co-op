...
if (g_deadTrooperShells == nil) then
	...
	g_deadTrooperShells.explosionProbability = CoopTrooper_x.autoDestructionProbability / 100
	g_deadTrooperShells.maxNum = CoopTrooper_x.maxDeadShellNum
end
...
function CoopTrooper_x:CreateAttachments()
...
function CoopTrooper_x:OnResetCustom()
...
function CoopTrooper_x:PlayAccelerationSound()
...
function CoopTrooper_x:Bleed(frameTime)
...
function CoopTrooper_x:ResetTimers()
...
function CoopTrooper_x.Client:OnHit(hit, remote)
...
------------------------------------------------------------------------------
function CoopTrooper_x:GetDamageMultiplier(hit)
...
function CoopTrooper_x.OnDeathCustom(self)
--	self:RemoveActor();
end


-----------------------------------------------------------------------------------------------------
function CoopTrooper_x:MakeParalyzed( dir, strength )
...
function CoopTrooper_x.SendWarning(entity,timerid)
...
function CoopTrooper_x.PlayFightSound(entity,timerid)
...
function CoopTrooper_x:InitiateAutoDestruction()
	self:SetTimer(TROOPER_WARMUP_AUTODESTRUCT_TIMER,self.WarmupAutoDestructionTime*1000);
	--self.iAutoDestructTimer = Script.SetTimer(self.WarmupAutoDestructionTime*1000,CoopTrooper_x.WarmupAutoDestruct,self);
	self.bAutoDestructing = true;
end

function CoopTrooper_x.AutoDestruct(entity)--,timerid)
...
function CoopTrooper_x:MeleeAttack(entity)
...
function CoopTrooper_x:GetMeleeDamageImpulse(impulse,dirtype)
	if(dirtype==1) then 
...
function CoopTrooper_x:MeleeDamage(impulse,meleeType)
	...
	if (entity) then 	  
		...
		if(distance) then
			...
			--AI.LogEvent( "CoopTrooper_x:MeleeDamage()" );
...
function CoopTrooper_x:SetFireMode()
...
function CoopTrooper_x:OnLoad(saved)
...
function CoopTrooper_x:OnSave(save)
...
function CoopTrooper_x:SetGrabbable(value)
	self.Properties.Damage.bNoGrab = 1 - (value or 0);
end

function CoopTrooper_x:Beam(target)
...
function CoopTrooper_x:RegisterWithExplosion(entity)
...
function CoopTrooper_x:NotifyExplosion()
...
-----------------------------------------------------------------------------------------------------
function CoopTrooper_x:GetDamageImpulseMultiplier(hit)
