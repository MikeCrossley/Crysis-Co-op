...
function CoopHunter_x:CreateAttachments()
...
--function CoopHunter_x.Client:OnAnimationEvent(animation,strPar,intPar)
--	Log("animation event on "..animation.." ("..intPar..")");
--end

------------------------------------------------------------------------------
function CoopHunter_x.Client:OnUpdate(frameTime)
...
------------------------------------------------------------------------------
function CoopHunter_x:UpdateGlow(frameTime)
...
------------------------------------------------------------------------------
function CoopHunter_x:SetGlow(glowtype, goal, speed, initial)
...
function CoopHunter_x.SetHunterGlowLevel( self, level )	
	--Log("Glow = %.3f", level);	
	local Glow = self.Glow;
...
------------------------------------------------------------------------------
function CoopHunter_x:CanHoldObject(mass,volume,query)
...
------------------------------------------------------------------------------
function CoopHunter_x:DoPlayerSeen()
	
  Log ("CoopHunter_x:DoPlayerSeen() called");	
	BasicAlien.DoPlayerSeen(self);
end

------------------------------------------------------------------------------
function CoopHunter_x:DoShootWeapon()

  Log ("CoopHunter_x:DoShootWeapon() called");	
...
--	end
	...
	if (not self:IsEventActive("weapon_attack")) then
		...
		--Log("CoopHunter_x:DoShootWeapon()");
...
------------------------------------------------------------------------------	
function CoopHunter_x:DoScream()
	if (self.isPlayingAnimation>0.01) then
		return 0;
	end
...
------------------------------------------------------------------------------
function CoopHunter_x:StopEverything(stopAnimation)
...
------------------------------------------------------------------------------
function CoopHunter_x:DoInvestigate()
...
------------------------------------------------------------------------------
function CoopHunter_x:TakeOffDropObjectAtPoint(targetPos)
...
------------------------------------------------------------------------------
function CoopHunter_x:GetDamageMultiplier(hit)
...
function CoopHunter_x:ResetDetachableSpots()
...
------------------------------------------------------------------------------
--FIXME:should be in basicalien?
--function CoopHunter_x:ProcessDetachableSpots(weaponId, matName, damage, hitType, pos, normal, partId)
function CoopHunter_x:ProcessDetachableSpots(hit)
...
function CoopHunter_x:OnSave (save)
...
function CoopHunter_x:OnLoad (save)
...
------------------------------------------------------------------------------
function CoopHunter_x.Server:OnHit(hit)

	--Log("CoopHunter_x.Server:OnHit");
...
------------------------------------------------------------------------------
function CoopHunter_x:OnVulnerableHit(partId, materialType)
...
------------------------------------------------------------------------------
function CoopHunter_x.Client:OnTimer(timerId,mSec)
...
------------------------------------------------------------------------------
function CoopHunter_x:ProcessHighPose (hit, damageMult)
...
------------------------------------------------------------------------------
function CoopHunter_x:Kill(ragdoll, shooterId, weaponId)
...
------------------------------------------------------------------------------
function CoopHunter_x.Client:OnHit(hit, remote)
...
--function CoopHunter_x:Event_GoPatrol( params )
--	AI.Signal(0, 1, "GO_PATROL", self.id);
--end	
--
--function CoopHunter_x:Event_GoSearch( params )
--	AI.Signal(0, 1, "GO_SEARCH", self.id);
--end	
--
--function CoopHunter_x:Event_GoEscort( params )
--	AI.Signal(0, 1, "GO_ESCORT", self.id);
--end	

------------------------------------------------------------------------------
function CoopHunter_x:GrabEntity(entityname)
...
------------------------------------------------------------------------------
function CoopHunter_x:DropGrab()
...
------------------------------------------------------------------------------
function CoopHunter_x.Client:OnCollision(hit)
...
------------------------------------------------------------------------------
function CoopHunter_x:ScriptEvent(event,value,str)
...
------------------------------------------------------------------------------
function CoopHunter_x:AnimationEvent(event,value)
...
------------------------------------------------------------------------------
function CoopHunter_x:GetWeaponDir(weapon)
...
------------------------------------------------------------------------------
function CoopHunter_x.OnDeath( entity )
	Log(" >>>> CoopHunter_x.OnDeath "..entity:GetName());
	entity:TriggerEvent(AIEVENT_AGENTDIED);
end 

------------------------------------------------------------------------------
function CoopHunter_x:SetGrabbingScheme(scheme)
...
function CoopHunter_x:GrabObject(object, query)
...
------------------------------------------------------
function CoopHunter_x:Event_GrabVTOL(sender)
...
------------------------------------------------------
function CoopHunter_x:Event_ReleaseVTOL(sender)
...
----------------------------------------------------
function CoopHunter_x:HealthChanged()	
...
----------------------------------------------------
CoopHunter_x.FlowEvents =
{
	Inputs =
	{
		GrabVTOL = { CoopHunter_x.Event_GrabVTOL, "bool" },
		ReleaseVTOL = { CoopHunter_x.Event_ReleaseVTOL, "bool" },		
	},
	Outputs =
	{
