...
function CoopAlien_x:CreateAttachments()
...
function CoopAlien_x:OnResetCustom()
...
function CoopAlien_x.Client:OnUpdate(frameTime)
...
function CoopAlien_x:Bleed(frameTime)
...
function CoopAlien_x:Kill(ragdoll, shooterId, weaponId)
...
function CoopAlien_x.Client:OnHit(hit, remote)
...
--------------------------------------------------------------------------------------------------------
function CoopAlien_x:OnAGSlowSpeed()
...
--------------------------------------------------------------------------------------------------------
function CoopAlien_x:OnAGNormalSpeed()
...
--------------------------------------------------------------------------------------------------------
function CoopAlien_x:AlienMakeIdle()
	-- Make this guy idle
...
--------------------------------------------------------------------------------------------------------
function CoopAlien_x:AlienMakeAlerted( noDrawWeapon )
...
function CoopAlien_x:MakeParalyzed( dir, strength )
...
function CoopAlien_x:OnSave(save)
...
function CoopAlien_x:OnLoad(save)
