...
--Grunt=CreateAI(CoopGrunt_x)
-----------------------------------------------------------------------------------------------------
--function CoopGrunt_x:Event_Talk(sender)
...
--CoopGrunt_x.FlowEvents =
--{
--	Inputs =
--	{
--		Alert = { CoopGrunt_x.Event_Alert, "bool" },
--		Talk = { CoopGrunt_x.Event_Talk, "bool" },
--	},
--	Outputs =
--	{
--		Alert = "bool",
